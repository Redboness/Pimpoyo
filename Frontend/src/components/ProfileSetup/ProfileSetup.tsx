...
const preSurveyQuestions: AnyPreSurveyQuestion[] = [
    ...
    { id: 'P3_Habilidad_Tech', text: '3. En una escala del 1 (me cuesta mucho) al 5 (se me da genial), ¿cómo de bien se te da usar tecnologías como el móvil, la tablet o el ordenador?', type: 'radio', options: ['1', '2', '3', '4', '5'] },
    { id: 'P4_Charla_Peligros', text: '4. ¿Con qué frecuencia tus padres, profesores u otros adultos te hablan sobre los peligros de internet o cómo reconocer noticias falsas?', type: 'radio', options: ['Muy a menudo', 'A menudo.', 'Alguna vez.', 'Casi nunca.', 'Nunca.'] },
    // Sección 2
    { id: 'P5_Habilidad_VF', text: '5. En una escala del 1 (no soy nada bueno) al 5 (¡se me da genial!), ¿cómo dirías que se te da descubrir si una noticia que ves en internet o redes sociales es verdadera o es falsa?', type: 'radio', options: ['1', '2', '3', '4', '5'] },
    { id: 'P6_Dificultad_VF', text: '6. ¿Cómo de difícil crees que es saber si una noticia es real hoy en día?', type: 'radio', options: ['1 - Muy fácil', '2 - Bastante fácil', '3 - Ni fácil ni difícil', '4 - Bastante difícil', '5 - Muy difícil'] },
    ...
    { id: 'P8_Fuentes_Confianza', text: '8. ¿Qué tipo de FUENTES (quién escribe o publica) te hacen CONFIAR MÁS en que una noticia es verdad? (Puedes marcar TODAS las que te den confianza)', type: 'checkbox', options: ['Periódicos, telediarios o webs de noticias famosas.', 'Webs oficiales (del gobierno, de la NASA, de universidades...).', 'Un científico o experto conocido que habla del tema.', 'Mis amigos o mi familia cuando me cuentan algo.', 'Un Youtuber o Tiktoker con muchos seguidores.', 'Cualquier web que parezca profesional, aunque no la conozca.', 'Mensajes que se reenvían mucho por WhatsApp.'] },
